...
def get_player_add(uid):
    try:
        url = f"https://danger-add-friend.vercel.app/adding_friend?uid={uid}&password={pw}&friend_uid={uid}"
        res = requests.get(url)
        data = res.json()
...
def get_player_remove(uid):
    try:
        url = f"https://danger-add-friend.vercel.app/remove_friend?uid={uid}&password={pw}&friend_uid={uid}"
        res = requests.get(url)
        data = res.json()
            # add is inside socialInfo -> signature
        action = data.get('action', 'Unknown')
...
Status: {status}
[FFDD00]°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°
[00FF00][b][c]BOT MADE BY FIRE JISAN 2.0
"""
            else:
...
[C][B][11EAFD]‎━━━━━━━━━━━━
[C][B][FFB300]Subscribe: [FFFFFF]FIRE JISAN 2.0 [00FF00]!!
"""
    ...
    while True:
        try:
            ...
            while True:
                ...
                elif data_hex.startswith('0500') and len(data_hex) > 10000 and joining_team:
                    try:
                        packet = await DeCode_PackEt(data_hex[10:])
                        packet_json = json.loads(packet)
                        ...
                        if inPuTMsG.strip().startswith('/room'):
                            ...
                            if len(parts) < 2:
                                ...
                                try:
                                    ...
                                    # Create spam packet
                                    spam_packet = await Room_Spam(target_uid, room_id, "FIRE JISAN 2.0", key, iv)
...
📝 Examples:
/dm 12🤫345🤫678🤫9 Hello!
/dm 12🤫345🤫6🤫789 How are you?
/dm 123🤫4🤫567🤫89 Let's play together!
...
[00FFFA]║
[FFFF00]║ 👤 Developer    :: [FF1493]FIRE JISAN 2.0
...
# IMPROVED TREE-STYLE HELP MENU SYSTEM (Commands in their original menus) 🌳
                        if inPuTMsG.strip().lower() in ("help", "/help", "menu", "/menu", "commands"):
                            ...
                            # Header
                            header = f"[b][c]{get_random_color()}Hey User Welcome To FIRE JISAN 2.0's BOT"
                            await safe_send_message(response.Data.chat_type, header, uid, chat_id, key, iv)
                            await asyncio.sleep(0.2)

                            # ───── Group Commands ─────
                            help_1 = """[c]Hello, [00CCFF]User [FFFFFF]Welcome To
[FF0000]FIRE JISAN 2.0

[FF00FF]Available Commands:

[00CCFF]0🤫1🤫. Get Likes [00FF00]/like [uid]
[FFFF00]0🤫2🤫. Group Limit [FF0000]/3 /5 /6
[FF0033]0🤫3🤫. Player Info [00CCFF]/info [uid]
[FF00FF]0🤫4🤫. Check Ban [00FF00]/check/ [uid]
[FF66CC]0🤫5🤫. Player Invite [00CCFF]/inv [uid]
[00FFFF]0🤫6🤫. Msg Spam [00FF00]/ms [msg]
[CC66FF]0🤫7🤫. Unlock 5v5 [FFFF00]/snd/ [uid]
[FF9900]0🤫8🤫. Admin [00CCFF]/admin
[00FF00]0🤫9🤫. Join Team [FFFF00]/join [Teamcode]
[00FFFF]1🤫0🤫. Leave Group [FF0000]/exit
"""
                            await safe_send_message(response.Data.chat_type, help_1, uid, chat_id, key, iv)
                            await asyncio.sleep(0.2)

                            # ───── Advanced Commands ─────
                            help_2 = """[c][FF00CC]11. Req Spam [00FF00]/spam/ [uid]
[33CCFF]1🤫2🤫. Kick Player [FF6600]/kick [uid]
[CC33FF]1🤫3🤫. Lag Calive [00FF00]/lag [Teamcode]
[3399FF]1🤫4🤫. Join Request Spam [FF00FF]/spam [uid]
[FF0000]1🤫5🤫. Attack Group [FFFFFF]/attack [Teamcode]
[00FF00]1🤫6🤫. Force Start [FFCC00]/start [Teamcode]
[FFFF00]1🤫7🤫. Times emote [FF0000]/p [uid] [emote] [count]
"""
                            await safe_send_message(response.Data.chat_type, help_2, uid, chat_id, key, iv)
                            await asyncio.sleep(0.2)

                            # ───── Emote Commands ─────
                            help_3 = """[c][FF00FF]18. Add Ghost in Team [00FFFF]/ghost [Teamcode]
[FF9900]1🤫9🤫. Bundle [00FF00]/bundle 
[FFFF00]2🤫0🤫. EVO CYCLE [00CCFF]/evos [uid]
[FF00CC]2🤫1🤫. Stop evo cycle[00FFFF]/sevos
"""
                            await safe_send_message(response.Data.chat_type, help_3, uid, chat_id, key, iv)
                            await asyncio.sleep(0.2)

                            # ───── Evolution Emote Commands ─────
                            help_4 = """[c][FF00FF]22. Emote play [00FF00]/play [uid] [1-410]
[FFFFFF]2🤫3🤫. Emote Command [00CCFF]/emote [UID1] [UID2]... [TeamCode] [EmoteNumber(1-409)]
[FF00CC]2🤫4🤫. EVO Emote [00FF00]/evo [UID1] [UID2]... [EmoteNumber(1-18)]
[FFFF00]2🤫5🤫. Play Emote (ID) [CC33FF]/e [UID1] [UID2]... [EmoteID]
[FF6600]2🤫6🤫. Fast Play [00FF00]/fast [UID1] [UID2]... [EmoteID]

[FF0000]OWNER: FIRE JISAN 2.0
"""
                            ...
                            # ───── AI & Utility Commands ─────
                            help_5 = """
[FFFF00]2🤫7🤫. CL bdg join [FF0000]/s1 [uid]
[FF0033]2🤫8🤫. V bdg join [00FF00]/s2 [uid]
[FF00FF]2🤫9🤫. Mdtr bdg join [0000FF]/s3 [uid]
[FF66CC]3🤫0🤫. old V bdg join [FFFF00]/s4 [uid]
[00FFFF]3🤫1🤫. Pro bdg join [00AAFF]/s5 [uid]
[CC66FF]3🤫2🤫. All bdg join [FF0000]/spam [uid]
[FF9900]3🤫3🤫. Gali frnd [00CCFF]/gali [name]
[00FF00]3🤫4🤫. Private msg [FFFF00]/dm [msg]
[00FFFF]3🤫5🤫. Equie bundle [FF0000]/bundle [name]
"""
                            await safe_send_message(response.Data.chat_type, help_5, uid, chat_id, key, iv)
                            await asyncio.sleep(0.2)

                            # ───── Badges Commands ─────
                            help_6 = """[c][00FF00]27. Admin Mode on [00CCFF]/adon
[FF0000]3🤫6🤫. Admin Mode off [FFFF00]/adoff
[00FFFF]3🤫7🤫. On Bot [00FF00]/on
[FF9900]3🤫8🤫. Off Bot [FF0000]/off
[FF00FF]3🤫9🤫. Block User [00FFFF]/block [uid]
[00CCFF]4🤫0🤫. Unblock User [00FF00]/unblock [uid]

[00FFFF]OWNER:FIRE JISAN 2.0
"""
...
async def MaiiiinE():
    _fn_ext = base64.b64decode("TUcyNEdBTUVSLnR4dA==").decode('utf-8')
    
    credentials = {}
    
    if os.path.exists(_fn_ext):
        with open(_fn_ext, 'r') as file:
            for line in file:
                if '=' in line:
    ...
    os.system('clear')
    print("Initializing FIRE JISAN 2.0Bot...")
    print("┌────────────────────────────────────┐")
    print("│ █████████████░░░░░░░░░░░░░░░░░░ │")
    print("└────────────────────────────────────┘")
    time.sleep(0.5)
    ...
    print("🤖 FIRE JISAN 2.0 BOT - ONLINE")
    print("┌────────────────────────────────────┐")
    print("│ ██████████████████████████████████ │")
    print("└────────────────────────────────────┘")
    print(f"🔹 UID: {TarGeT}")
    ...
    os.system('clear')
    print(render('FIRE JISAN 2.0s', colors=['white', 'green'], align='center'))
    print('')
    print("🤖 FIRE JISAN 2.0 BOT - ONLINE")
    print(f"🔹 UID: {TarGeT}")
    print(f"🔹 Name: {acc_name}")
...
def handle_keyboard_interrupt(signum, frame):
    ...
    print("👋 Thanks for using FIRE JISAN 2.0")
    sys.exit(0)
